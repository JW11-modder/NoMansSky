...
PlayerMovementSpeedPercent = 200
PlayerMovementForcePercent = 150
PlayerJetpackSpeedPercent = 1500
PlayerJetpackForcePercent = 950
PlayerJetpackUpSpeedPercent = 200
PlayerJetpackUpForcePercent = 250

NMS_MOD_DEFINITION_CONTAINER =
{
["MOD_FILENAME"]    = "Player mobility upgrade (Ironman compatibility)",
["MOD_AUTHOR"]      = "jw11-modder",
["MOD_DESCRIPTION"] =
[[ A mod to tune player mobility, including jetpack and stamina capacity
!!!This version is compiled to be used with "Fly like Ironman" mod!!!
          ...
          {
            {
              ["VALUE_CHANGE_TABLE"] =
              {
                ...
                {"JetpackBrake", "@*"..(PlayerMovementForcePercent / 100)},
